...
module.exports = async appx => {
    ...
    api.get('/maps/api/*', async ctx => {
        ...
        console.debug({url, query, urlString});
        ...
        if (res.status !== 200) {
            console.debug('statusCode', url, res.status, res.statusText, query);
